...
\text{\textbf{Clark, D.}, Schumann, F., \& Mostofsky, S. (in preparation).
    Inhibition and Selection in ADHD and Minful Sensorimotor Practice.
    \emph{Fronteirs in Human Neuroscience}.}

\text{}

\text{Ranney, M., \& \textbf{Clark, D.} (in preparation). Climate Change
    Education Works. \emph{Trends in Cognitive Science.}}

\text{}

\text{\textbf{Clark, D.}, (2014). MTurk Admin. Retrieved from Open Science
    Framework. osf.io/iwdru}
...
\text{\textbf{Clark, D.} (accepted). A Common Scientific Compute
