...
\text{\textbf{Clark, D.} (in preparation). Quantitative Ethnography with
Frequent Sampling of Students’ Emotional and Cognitive States.}

\text{}

\text{Turek, D., Suen, A., and \textbf{Clark, D.} (in revision). The BIDS
    Collaborative: Towards Effective Graduate Student Data Science Projects.}
