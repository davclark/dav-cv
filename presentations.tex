\begin{rubric}{Other Presentations}

% http://www.upd.unibe.ch/research/symposien/HA18/herbstakademie_program_2015_online.pdf

\text{Schumann, F., and \textbf{Clark, D.} (March, 2015). \emph{Mindful movement and skilled
    attention.} Paper presented at the 18th Herbstakademie, Heidelberg, Germany. }

\text{}

\text{Ranney, M. A., \textbf{Clark, D.}, Lamprey, L.N., Le, K., Shonman, M., Hu,
    B.S., \& Zhang, L. (2014, November). \emph{Enhancing Climate Change Cognition:
    Direct-To-The-Public Communication (www.HowGlobalWarmingWorks.org) and
    Controlled Experiments.} Paper presented at the annual meeting of the
    Psychonomic Society, Long Beach, CA.}

\text{}

\text{\textbf{Clark, D.} (2014, October). \emph{Mindful sensorimotor practice:
        Why aren't we paying more attention?} Paper presented at the
    International Symposium for Contemplative Studies 2014, Boston, MA.}

\text{}

\text{\textbf{Clark, D.} (2013, November). \emph{Measuring and Reducing Individuals' Carbon
    Footprints.} Behavioral Measurement \& Change Seminar at UC Berkeley, Berkeley, CA.}
