...
% Will be 2012, April
\text{Reinholz, D., \textbf{Clark, D.} \& Ranney, M. A. (submitted) \emph{Conceptual
    Change in Climate Change: The Positive Effects of Learning Global
    Warming’s Mechanism.} Paper to be presented at the Annual Meeting of
    the American Educational Research Association, New Orleans, LA.}
% AERA does not state which number meeting this will be
...
\text{\textbf{Clark, D.}, Reinholz, D., Goldwasser, L., Ranney, M. A. (2011, April) 
    \emph{Can Teaching the "Goldilocks Asymmetry" About Energy Transfer Rates Save Us
    Organisms? An Experiment on Climate Change Instruction.} Paper presented at the
    Graduate School of Education (GSE) Research Day, Berkeley, CA.}
